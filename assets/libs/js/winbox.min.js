...
(function () {
    ...
    function R(a, b) {
        ...
        this.g.className = "winbox" + (O ? " " + ("string" === typeof O ?
            O : O.join(" ")) : "") + (e ? " modal" : "");
        this.x = h;
        this.y = c;
        this.width = u;
    ...
    function ha(a) {
        ...
        F ? l(a.g.getElementsByClassName("wb-full")[0], "click", function (b) {
            m(b);
            a.focus().fullscreen()
        }) : a.addClass("no-full");
    ...
    function U() {
        ...
        e = 0;
        for (var h, p, t; e < a; e++) d = r[e], h = d.left + ":" + d.top, p = Math.min((K - d.left - d.right) / c[h], 250), t = d.g.getElementsByClassName("wb-title")[0], t = t.clientHeight, b[h] || (b[h] = 0), d.resize(p + 1 | 0, 0, !0).move(d.left + b[h] * p | 0, P - d.bottom - t, !0), b[h]++
    }
    ...
    function W(a, b) {
        function c(f) {
            ...
            if (a.min) a.minimize();
                ...
                a.max || (w.classList.add("wb-drag"), (p = f.touches) && (p = p[0]) ? (f = p, l(window, "touchmove", e), l(window, "touchend", d)) : (l(window, "mousemove", e), l(window, "mouseup", d)), t = f.pageX, H = f.pageY, a.focus())
            }
        }
    ...
    g.maximize = function (a) {
        if ("undefined" === typeof a || a !== this.max) this.min && X(this), (this.max = !this.max) ? this.addClass("max").resize(K - this.left - this.right, P - this.top - this.bottom, !0).move(this.left, this.top, !0) : this.resize().move().removeClass("max");
        return this
    };
    ...
    g.move = function (a, b, c) {
        a || 0 === a ? c || (this.x = a ? a = T(a, K - this.left - this.right, this.width) : 0, this.y = b ? b = T(b, P - this.top - this.bottom, this.height) : 0) : (a = this.x, b = this.y, this.l && (0 === a ? this.resize(K / 2, P) : a === K - this.width && this.resize(K / 2, P)));
